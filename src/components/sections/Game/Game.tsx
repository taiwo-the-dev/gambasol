...
export function GameSlider() {
  return (
    <>
      <div className='grid grid-cols-1 gap-10 md:grid-cols-3 lg:grid-cols-4 md:justify-center'>
        {GAMES.map((game) => (
          <div key={game.id} className='flex justify-center md:my-2'>
            <GameCard game={game} />
          </div>
        ))}
      </div>
  ...
  return (
    <>
      ...
      <div className='w-full relative grid gap-1'>
        ...
        />
        <div className='w-full bg-[#1A1B28] p-2 sm:p-5 text-white rounded-lg flex flex-wrap gap-2 sm:gap-5 justify-center items-center sm:flex-row'>

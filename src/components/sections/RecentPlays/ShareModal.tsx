        ...
        <div className="rounded-lg overflow-hidden">
          ...
          >
            <div className="p-5 bg-black bg-opacity-40">
              ...
              <div className="mt-4 whitespace-nowrap justify-center items-center bg-black bg-opacity-20 backdrop-filter backdrop-blur-md rounded-lg p-3 flex md:gap-2">
                <Image src={logo} alt="Platform Icon" className="h-8 w-8" />
